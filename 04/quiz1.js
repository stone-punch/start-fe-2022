...
function get_start_index(page){
   ...
   var start_index = (page - 1) * list_num;
   return start_index;
}
...
function print_img(page){
    ...
    var str = '';
    for(var i=start_index; i < start_index + list_num; i++){
        if(todayPhoto[i]){
    ...
    $wrap.innerHTML = str;
    $page.innerHTML = page;
    $total_page.innerHTML = total_page;
}
